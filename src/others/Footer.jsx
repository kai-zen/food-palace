      ...
      <footer id="footer" style={{ position: 'relative' }}>
        ...
        <div className="container">
          <div className="row">
            ...
            <div
              id="footer-p1"
              className="offset-1 col-xs-10 col-md-5 offset-lg-0 col-lg-4 footer-div"
            >
              <h1>درباره ما</h1>
              <p>
                ...
                امتنی ساختگی و بدون معنی است که برای امتحان فونت و یا پر کردن
                فضا در یک طراحی گرافیکی و یا صنعت چاپ استفاده میشود.
              </p>
            ...
            <div
              id="footer-p3"
              className="offset-1 col-xs-10 offset-md-6 col-md-6 offset-lg-1 col-lg-3 footer-div"
            >
              <h1>خبرنامه</h1>
